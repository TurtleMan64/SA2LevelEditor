...
std::list<TexturedModel*> SHELTH::models;
CollisionModel* SHELTH::cmBase;
...
SHELTH::SHELTH(char data[32], bool /*useDefaultValues*/)
{
    ...
    collideModelOriginal = SHELTH::cmBase;
    collideModelTransformed = SHELTH::cmBase->duplicateMe();
...
std::list<TexturedModel*>* SHELTH::getModels()
{
    return &SHELTH::models;
}

void SHELTH::loadStaticModels()
{
    if (SHELTH::models.size() > 0)
    {
        return;
    }

    #ifdef DEV_MODE
    std::fprintf(stdout, "Loading SHELTH static models...\n");
    #endif

    loadModel(&SHELTH::models, "res/Models/LevelObjects/IronGate/", "SHELTH");

    if (SHELTH::cmBase == nullptr)
    {
        SHELTH::cmBase = loadCollisionModel("res/Models/LevelObjects/IronGate/", "SHELTH");
    }
}

void SHELTH::deleteStaticModels()
{
    #ifdef DEV_MODE
    std::fprintf(stdout, "Deleting SHELTH static models...\n");
    #endif

    Entity::deleteModels(&SHELTH::models);
    Entity::deleteCollisionModel(&SHELTH::cmBase);
}

void SHELTH::updateValue(int btnIndex)
{
    char buf[128];
...
void SHELTH::updateEditorWindows()
{
...
void SHELTH::fillData(char data[32])
{
    data[1] = (char)ID;
