...
CollisionModel* GOALRING::cmBase;
...
GOALRING::GOALRING(char data[32], bool useDefaultValues)
{
    ...
    collideModelOriginal = GOALRING::cmBase;
    collideModelTransformed = GOALRING::cmBase->duplicateMe();
    collideModelTransformed->parent = this;
    CollisionChecker::addCollideModel(collideModelTransformed);
    updateCollisionModelY();
}

bool GOALRING::isSA2Object()
{
    return true;
}
...
void GOALRING::loadStaticModels()
{
    ...
    loadModel(&GOALRING::models, "res/Models/GlobalObjects/GOALRING/", "Sphere");

    if (GOALRING::cmBase == nullptr)
    {
        GOALRING::cmBase = loadCollisionModel("res/Models/GlobalObjects/GOALRING/", "Sphere");
    }
}
...
void GOALRING::deleteStaticModels()
{
    ...
    Entity::deleteCollisionModel(&GOALRING::cmBase);
}

void GOALRING::updateValue(int btnIndex)
{
    char buf[128];
...
void GOALRING::updateEditorWindows()
{
    ...
    SetWindowTextA(Global::windowLabels[ 6], "Unknown");
    ...
    SetWindowTextA(Global::windowValues[ 1], "GOALRING");
    SetWindowTextA(Global::windowValues[ 2], std::to_string(position.x).c_str());
    SetWindowTextA(Global::windowValues[ 3], std::to_string(position.y).c_str());
    SetWindowTextA(Global::windowValues[ 4], std::to_string(position.z).c_str());
    ...
    SetWindowTextA(Global::windowDescriptions[ 1], "GOALRING");
...
void GOALRING::fillData(char data[32])
{
    data[1] = (char)ID;
