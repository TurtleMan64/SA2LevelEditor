...
std::list<TexturedModel*> CONTIRON::models;
CollisionModel* CONTIRON::cmBase;
...
CONTIRON::CONTIRON(char data[32], bool useDefaultValues)
{
    ...
    collideModelOriginal = CONTIRON::cmBase;
    collideModelTransformed = CONTIRON::cmBase->duplicateMe();
    collideModelTransformed->parent = this;
    CollisionChecker::addCollideModel(collideModelTransformed);
    updateCollisionModelY();
}

bool CONTIRON::isSA2Object()
{
    return true;
}
...
std::list<TexturedModel*>* CONTIRON::getModels()
{
    return &CONTIRON::models;
}

void CONTIRON::loadStaticModels()
{
    if (CONTIRON::models.size() > 0)
    {
        return;
    }

    #ifdef DEV_MODE
    std::fprintf(stdout, "Loading CONTIRON static models...\n");
    #endif

    loadModel(&CONTIRON::models, "res/Models/GlobalObjects/Box/CONTIRON/", "CONTIRON");

    if (CONTIRON::cmBase == nullptr)
    {
        CONTIRON::cmBase = loadCollisionModel("res/Models/GlobalObjects/Box/CONTIRON/", "CONTIRON");
    }
}

void CONTIRON::deleteStaticModels()
{
    #ifdef DEV_MODE
    std::fprintf(stdout, "Deleting CONTIRON static models...\n");
    #endif

    Entity::deleteModels(&CONTIRON::models);
    Entity::deleteCollisionModel(&CONTIRON::cmBase);
}

void CONTIRON::updateValue(int btnIndex)
{
    char buf[128];
...
void CONTIRON::updateEditorWindows()
{
    ...
    SetWindowTextA(Global::windowValues[ 1], "CONTIRON");
    SetWindowTextA(Global::windowValues[ 2], std::to_string(position.x).c_str());
    SetWindowTextA(Global::windowValues[ 3], std::to_string(position.y).c_str());
    SetWindowTextA(Global::windowValues[ 4], std::to_string(position.z).c_str());
    ...
    SetWindowTextA(Global::windowDescriptions[ 1], "CONTIRON");
...
void CONTIRON::fillData(char data[32])
{
    data[1] = (char)ID;
