...
CollisionModel* MOTOBUG::cmBase = nullptr;
...
MOTOBUG::MOTOBUG(char data[32], bool useDefaultValues)
{
    ...
    collideModelOriginal = MOTOBUG::cmBase;
    collideModelTransformed = MOTOBUG::cmBase->duplicateMe();
    collideModelTransformed->parent = this;
    CollisionChecker::addCollideModel(collideModelTransformed);
    updateCollisionModelYXZ();
}

bool MOTOBUG::isSA2Object()
{
    return true;
}
...
void MOTOBUG::loadStaticModels()
{
    ...
    loadModel(&MOTOBUG::models, "res/Models/GlobalObjects/Badniks/Motobug/", "Motobug");

    if (MOTOBUG::cmBase == nullptr)
    {
        MOTOBUG::cmBase = loadCollisionModel("res/Models/GlobalObjects/Badniks/Motobug/", "Motobug");
    }
}
...
void MOTOBUG::deleteStaticModels()
{
    ...
    Entity::deleteCollisionModel(&MOTOBUG::cmBase);
}

void MOTOBUG::updateValue(int btnIndex)
{
    char buf[128];
...
void MOTOBUG::updateEditorWindows()
{
    ...
    SetWindowTextA(Global::windowValues[ 1], "MOTOBUG");
    SetWindowTextA(Global::windowValues[ 2], std::to_string(position.x).c_str());
    SetWindowTextA(Global::windowValues[ 3], std::to_string(position.y).c_str());
    SetWindowTextA(Global::windowValues[ 4], std::to_string(position.z).c_str());
    SetWindowTextA(Global::windowValues[ 5], std::to_string(Maths::bamsToDeg(rotationX)).c_str());
    ...
    SetWindowTextA(Global::windowDescriptions[ 1], "Moto Bug");
...
void MOTOBUG::fillData(char data[32])
{
    data[1] = (char)ID;
...
std::string MOTOBUG::toSabString()
{
    return "120 " + 
