...
std::list<TexturedModel*> TJUMPDAI::models;
CollisionModel* TJUMPDAI::cmBase;
...
TJUMPDAI::TJUMPDAI(char data[32], bool useDefaultValues)
{
    ...
    collideModelOriginal = TJUMPDAI::cmBase;
    collideModelTransformed = TJUMPDAI::cmBase->duplicateMe();
...
std::list<TexturedModel*>* TJUMPDAI::getModels()
{
    return &TJUMPDAI::models;
}

void TJUMPDAI::loadStaticModels()
{
    if (TJUMPDAI::models.size() > 0)
    {
        return;
    }

    #ifdef DEV_MODE
    std::fprintf(stdout, "Loading TJUMPDAI static models...\n");
    #endif

    loadModel(&TJUMPDAI::models, "res/Models/GlobalObjects/TJUMPDAI/", "TJUMPDAI");
    if (TJUMPDAI::cmBase == nullptr)
    {
        TJUMPDAI::cmBase = loadCollisionModel("res/Models/GlobalObjects/TJUMPDAI/", "TJUMPDAI");
    }
}

void TJUMPDAI::deleteStaticModels()
{
    #ifdef DEV_MODE
    std::fprintf(stdout, "Deleting TJUMPDAI static models...\n");
    #endif

    Entity::deleteModels(&TJUMPDAI::models);
    Entity::deleteCollisionModel(&TJUMPDAI::cmBase);
}

void TJUMPDAI::updateValue(int btnIndex)
{
    char buf[128];
...
void TJUMPDAI::updateEditorWindows()
{
    ...
    SetWindowTextA(Global::windowValues[ 1], "TJUMPDAI");
    SetWindowTextA(Global::windowValues[ 2], std::to_string(position.x).c_str());
    SetWindowTextA(Global::windowValues[ 3], std::to_string(position.y).c_str());
    SetWindowTextA(Global::windowValues[ 4], std::to_string(position.z).c_str());
    SetWindowTextA(Global::windowValues[ 5], std::to_string(rotationX).c_str());
    ...
    SetWindowTextA(Global::windowDescriptions[ 8], "Unknown.");
    SetWindowTextA(Global::windowDescriptions[ 9], "Unknown.");
    SetWindowTextA(Global::windowDescriptions[10], "Unknown.");

    updateTransformationMatrixYXZ();
    updateCollisionModelYXZ();
}

void TJUMPDAI::fillData(char data[32])
{
    data[1] = (char)ID;
...
std::string TJUMPDAI::toSabString()
{
    return "";
}
