...
std::list<TexturedModel*> SEARCHER::models;
CollisionModel* SEARCHER::cmBase = nullptr;
...
SEARCHER::SEARCHER(char data[32], bool useDefaultValues)
{
    ...
    collideModelOriginal = SEARCHER::cmBase;
    collideModelTransformed = SEARCHER::cmBase->duplicateMe();
    collideModelTransformed->parent = this;
    CollisionChecker::addCollideModel(collideModelTransformed);
    updateCollisionModelYXZ();
}

bool SEARCHER::isSA2Object()
{
    return true;
}
...
std::list<TexturedModel*>* SEARCHER::getModels()
{
    return &SEARCHER::models;
}

void SEARCHER::loadStaticModels()
{
    if (SEARCHER::models.size() > 0)
    {
        return;
    }

    #ifdef DEV_MODE
    std::fprintf(stdout, "Loading SEARCHER static models...\n");
    #endif

    loadModel(&SEARCHER::models, "res/Models/GlobalObjects/Heroes/Flapper/Red/", "Flapper");

    if (SEARCHER::cmBase == nullptr)
    {
        SEARCHER::cmBase = loadCollisionModel("res/Models/GlobalObjects/Heroes/Flapper/Red/", "Flapper");
    }
}

void SEARCHER::deleteStaticModels()
{
    #ifdef DEV_MODE
    std::fprintf(stdout, "Deleting SEARCHER static models...\n");
    #endif

    Entity::deleteModels(&SEARCHER::models);
    Entity::deleteCollisionModel(&SEARCHER::cmBase);
}

void SEARCHER::updateValue(int btnIndex)
{
    char buf[128];
...
void SEARCHER::updateEditorWindows()
{
    ...
    SetWindowTextA(Global::windowDescriptions[ 1], "Flapper");
...
void SEARCHER::fillData(char data[32])
{
    data[1] = (char)ID;
...
std::string SEARCHER::toSabString()
{
    Vector3f dir(1, 0, 0);
